...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Manage cards 
        $manageCards = Permission::create(['name' => 'manage_cards', 'display_name' => 'الباقات' , 'route' => 'cards' , 'module' => 'cards' , 'as' => 'cards.index' , 'icon' => 'fas fa-file-archive' , 'parent' => $manageCardCategories->id , 'parent_original' => '0' , 'sidebar_link' => '1' , 'appear' => '1' , 'ordering' => '30',] );
