...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //main sliders
        $manageMainSliders = Permission::create(['name' => 'manage_main_sliders', 'display_name' => 'إدارة عارض الشرائح' , 'route' => 'main_sliders' , 'module' => 'main_sliders' , 'as' => 'main_sliders.index' , 'icon' => 'fas fa-sliders-h' , 'parent' => '0' , 'parent_original' => '0' , 'sidebar_link' => '1' , 'appear' => '1' , 'ordering' => '20',] );
        ...
        //Advertisor sliders
        $manageAdvertisorSliders = Permission::create(['name' => 'manage_advertisor_sliders', 'display_name' => ' عارض شرائح الإعلانات' , 'route' => 'advertisor_sliders' , 'module' => 'advertisor_sliders' , 'as' => 'advertisor_sliders.index' , 'icon' => 'fas fa-sliders-h' , 'parent' => $manageMainSliders->id , 'parent_original' => '0' , 'sidebar_link' => '1' , 'appear' => '1' , 'ordering' => '25',] );
        ...
        $deleteProductCategories  =  Permission::create(['name' => 'delete_advertisor_sliders'  , 'display_name'  => 'حذف الشريحة'             ,  'route' => 'advertisor_sliders' , 'module' => 'advertisor_sliders' , 'as' => 'advertisor_sliders.destroy'  , 'icon' => null                  , 'parent' => $manageAdvertisorSliders->id , 'parent_original' => $manageAdvertisorSliders->id ,'parent_show' => $manageAdvertisorSliders->id , 'sidebar_link' => '0' , 'appear' => '0'] );
         ...
         //manage cards
         $manageCards = Permission::create(['name' => 'manage_cards', 'display_name' => 'إدارة البطائق' , 'route' => 'cards' , 'module' => 'cards' , 'as' => 'cards.index' , 'icon' => 'fas fa-file-archive' , 'parent' => '0', 'parent_original' => '0' , 'sidebar_link' => '1' , 'appear' => '1' , 'ordering' => '30',] );
        ...
        $manageProduct_cards = Permission::create(['name' => 'manage_product_cards', 'display_name' => 'الباقات' , 'route' => 'product_cards' , 'module' => 'product_cards' , 'as' => 'product_cards.index' , 'icon' => 'fas fa-file-archive' , 'parent' => $manageCards->id , 'parent_original' => '0' , 'sidebar_link' => '1' , 'appear' => '1' , 'ordering' => '35',] );
