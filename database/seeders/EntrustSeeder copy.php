...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $deleteProducts  =  Permission::create(['name' => 'delete_products'  , 'display_name'  => 'حذف منتج'            , 'route' => 'products' , 'module' => 'products' , 'as' => 'products.destroy'  , 'icon' => null           , 'parent' => $manageProducts->id , 'parent_original' => $manageProducts->id ,'parent_show' => $manageProducts->id , 'sidebar_link' => '0' , 'appear' => '0'] );
         ...
         $manageCardCategories = Permission::create(['name' => 'manage_card_categories', 'display_name' => 'إدارة البطائق' , 'route' => 'card_categories' , 'module' => 'card_categories' , 'as' => 'card_categories.index' , 'icon' => 'fas fa-file-archive' , 'parent' => '0', 'parent_original' => '0' , 'sidebar_link' => '1' , 'appear' => '1' , 'ordering' => '25',] );
        ...
        $manageProduct_cards = Permission::create(['name' => 'manage_product_cards', 'display_name' => 'الباقات' , 'route' => 'product_cards' , 'module' => 'product_cards' , 'as' => 'product_cards.index' , 'icon' => 'fas fa-file-archive' , 'parent' => $manageCardCategories->id , 'parent_original' => '0' , 'sidebar_link' => '1' , 'appear' => '1' , 'ordering' => '30',] );
