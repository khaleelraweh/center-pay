...
@section('content') 
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">الاسئلة الشائعة </h6>
            <div class="ml-auto">
                ...
                <a href="{{route('admin.common_questions.create')}}" class="btn btn-primary">
                    ...
                    <span class="text">إضافة سؤال شائع جديد  </span>
                </a>
                @endability
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{route('admin.common_questions.edit', $question->id)}}" class="btn btn-primary">
                            ...
                            <form action="{{route('admin.common_questions.destroy',$question->id)}}" method="post" class="d-none" id="delete-question-{{$question->id}}">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
