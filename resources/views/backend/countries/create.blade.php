...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">إضافة دولة</h6>
            <div class="ml-auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name_native" value="{{old('name_native')}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="country_code" value="{{old('country_code')}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="phone_code" value="{{old('phone_code')}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-3 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="currency_name" value="{{old('currency_name')}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-3 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="currency_name_native" value="{{old('currency_name_native')}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-3 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="currency" value="{{old('currency')}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-3 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="currency_symbol" value="{{old('currency_symbol')}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="capital" value="{{old('capital')}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                ...
                                <select name="region" class="form-control">
                                    ...
                                    <option value="Americas" {{ old('region') == 'Americas' ? 'selected' : null}}>امريكا</option>
                                    <option value="Europe" {{ old('region') == 'Europe' ? 'selected' : null}}>اوروبا</option>
                                    <option value="Africa" {{ old('region') == 'Africa' ? 'selected' : null}}>افريقيا</option>
                                    <option value="Oceania" {{ old('region') == 'Oceania' ? 'selected' : null}}>استراليا</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="nationality" value="{{old('nationality')}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="nationality_native" value="{{old('nationality_native')}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="emoji" value="{{old('emoji')}}" class="form-control" placeholder="">
