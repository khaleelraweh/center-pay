...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">تعديل بيانات طريقة الدفع {{ $paymentMethodOffline->name }}</h6>
            <div class="ml-auto">
                <a href="{{ route('admin.payment_method_offlines.index') }}" class="btn btn-primary">
                    <span class="icon text-white-50">
                        <i class="fa fa-home"></i>
                    </span>
                    <span class="text">إدارة طرق الدفع</span>
                </a>
            </div>
        </div>
