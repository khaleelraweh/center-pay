...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">إنشاء حساب جديد</h6>
            <div class="ml-auto">
                <a href="{{route('admin.customers.index')}}" class="btn btn-primary">
                    <span class="icon text-white-50">
                        <i class="fa fa-home"></i>
                    </span>
                    <span class="text">إدارة العملاء </span>
                </a>
            </div>
        </div>
                                ...
                                <div class="row pt-4">
                                    <div class="col-12">
                                        ...
                                        <div class="file-loading">
                                            <input type="file" name="user_image" id="customer_image" value="{{old('customer_image')}}"  class="file-input-overview ">
