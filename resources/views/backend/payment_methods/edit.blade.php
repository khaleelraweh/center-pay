...
@section('content')
    ...
    <div class="card shadow mb-4"> 
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">تعديل بيانات طريقة الدفع ( {{ $payment_method->name }} )</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{route('admin.payment_methods.update',$payment_method->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="name" value="{{old('name',$payment_method->name)}}" class="form-control" placeholder="">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="code" name="code" value="{{old('code',$payment_method->code)}}" class="form-control" placeholder="">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="driver_name" name="driver_name" value="{{old('driver_name',$payment_method->driver_name)}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="merchant_email" name="merchant_email" value="{{old('merchant_email',$payment_method->merchant_email)}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="merchant_password" name="merchant_password" value="{{old('merchant_password',$payment_method->merchant_password)}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="client_id" name="client_id" value="{{old('client_id',$payment_method->client_id)}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="client_secret" name="client_secret" value="{{old('client_secret',$payment_method->client_secret)}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="username" name="username" value="{{old('username',$payment_method->username)}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="password" name="password" value="{{old('password',$payment_method->password)}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="signature" name="signature" value="{{old('signature',$payment_method->signature)}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_merchant_email" name="sandbox_merchant_email" value="{{old('sandbox_merchant_email',$payment_method->sandbox_merchant_email)}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_merchant_password" name="sandbox_merchant_password" value="{{old('sandbox_merchant_password',$payment_method->sandbox_merchant_password)}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_client_id" name="sandbox_client_id" value="{{old('sandbox_client_id',$payment_method->sandbox_client_id)}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_client_secret" name="sandbox_client_secret" value="{{old('sandbox_client_secret',$payment_method->sandbox_client_secret)}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_username" name="sandbox_username" value="{{old('sandbox_username',$payment_method->sandbox_username)}}" class="form-control" placeholder="">
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_password" name="sandbox_password" value="{{old('sandbox_password',$payment_method->sandbox_password)}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sandbox_signature" name="sandbox_signature" value="{{old('sandbox_signature',$payment_method->sandbox_signature)}}" class="form-control" placeholder="">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="published_on" name="published_on" value="{{old('published_on',\Carbon\Carbon::parse($payment_method->published_on)->Format('Y-m-d'))}}" class="form-control" >
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="published_on_time" name="published_on_time" value="{{old('published_on_time',\Carbon\Carbon::parse($payment_method->published_on)->Format('h:i A'))}}" class="form-control" >
