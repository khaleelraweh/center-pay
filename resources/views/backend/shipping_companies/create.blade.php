                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4 pt-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="description" name="description" value="{{old('description')}}" class="form-control" placeholder="">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4 pt-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="cost" name="cost" value="{{old('cost')}}" class="form-control" placeholder="">
