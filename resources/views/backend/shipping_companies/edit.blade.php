...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">تعديل بيانات شركة الشحن : ({{$shipping_company->name}})</h6>
            <div class="ml-auto">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 pt-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" value="{{old('name',$shipping_company->name)}}" class="form-control" placeholder="">
                    ...
                    <div class="col-sm-12 col-md-4 pt-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="code" name="code" value="{{old('code',$shipping_company->code)}}" class="form-control" placeholder="">
                    ...
                    <div class="col-sm-12 col-md-4 pt-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="description" name="description" value="{{old('description',$shipping_company->description)}}" class="form-control" placeholder="">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4 pt-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="cost" name="cost" value="{{old('cost',$shipping_company->cost)}}" class="form-control" placeholder="">
