...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">تعديل كوبون الخصم :   {{$coupon->code}}</h6>
            <div class="ml-auto">
                <a href="{{route('admin.coupons.index')}}" class="btn btn-primary">
                    <span class="icon text-white-50">
                        <i class="fa fa-home"></i>
                    </span>
                    <span class="text">إادارة كوبونات الخصم</span>
                </a>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 pt-4">
                                        ...
                                        <select name="type" class="form-control">
                                            <option value="">---</option>
                                            <option value="fixed" {{old('type' , $coupon->type) == 'fixed' ? 'selected' : null }}>قيمة ثابته</option>
                                            <option value="percentage" {{old('type' , $coupon->type) == 'percentage' ? 'selected' : null }}>نسبة المئوية</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="value" name="value" value="{{old('value' , $coupon->value)}}" class="form-control" >
                                    ...
                                    <div class="col-sm-12 col-md-6 pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="use_times" name="use_times" value="{{old('use_times' , $coupon->use_times)}}" class="form-control" >
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="start_date" name="start_date" value="{{old('start_date',$coupon->start_date->format('Y-m-d'))}}" class="form-control" >
                                    ...
                                    <div class="col-sm-12 col-md-6 pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="expire_date" name="expire_date" value="{{old('expire_date', $coupon->expire_date->format('Y-m-d'))}}" class="form-control" >
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-ms-12 pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="greater_than" name="greater_than" value="{{old('greater_than' , $coupon->greater_than)}}" class="form-control" >
                        ...
                        <div class="row">
                            <div class="col-6 pt-4">
                                ...
                                <select name="status" class="form-control">
                                    <option value="1" {{ old('status', $coupon->status) == '1' ? 'selected' : null}}>مفعل</option>
                                    <option value="0" {{ old('status', $coupon->status) == '0' ? 'selected' : null}}>غير مفعل</option>
                                </select>
                            ...
                            <div class="col-6 pt-4">
                                ...
                                <select name="featured" class="form-control">
                                    <option value="1" {{ old('featured', $coupon->featured) == '1' ? 'selected' : null}}>نعم</option>
                                    <option value="0" {{ old('featured', $coupon->featured) == '0' ? 'selected' : null}}>لا</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="published_on" name="published_on" value="{{old('published_on',\Carbon\Carbon::parse($coupon->published_on)->Format('Y-m-d'))}}" class="form-control" >
                            ...
                            <div class="col-sm-12 col-md-6 pt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="published_on_time" name="published_on_time" value="{{old('published_on_time',\Carbon\Carbon::parse($coupon->published_on)->Format('h:i A'))}}" class="form-control" >
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <select name="view_in_main" class="form-control">
                                    <option value="1" {{ old('view_in_main', $coupon->view_in_main) == '1' ? 'selected' : null}}>مفعل</option>
                                    <option value="0" {{ old('view_in_main', $coupon->view_in_main) == '0' ? 'selected' : null}}>غير مفعل</option>
                                </select>
