...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        @include('backend.product_cards.filter.filter')
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{route('admin.product_cards.edit', $product->id)}}" class="btn btn-primary">
                            ...
                            <form action="{{route('admin.product_cards.destroy',$product->id)}}" method="post" class="d-none" id="delete-product-{{$product->id}}">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
