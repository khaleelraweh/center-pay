...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <div class="ml-auto">
                <a href="{{route('admin.product_cards.index')}}" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            <form action="{{route('admin.product_cards.update',$product->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                    ...
                    <div class="tab-pane fade" id="pricing" role="tabpanel" aria-labelledby="pricing-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <input type="number" name="quantity" id="quantity"  value="{{old('quantity',$product->quantity)}}"   class="form-control" placeholder="-1" data-parsley-range="[-1,1000]" data-parsley-required-message="هذا الحقل مطلوب." placeholder="0" data-parsley-range="[-1,1000]" data-parsley-range-message="قيمة هذا الحقل بين [0,999]." >
                                @error('quantity') <span class="text-danger">{{$message}}</span> @enderror                        
                                
                                <div class="col-md-12 col-sm-12 ">
                                    <label class="col-form-label col-md-12 col-sm-12 ">
                                      <input id="checkIn" name="Quantity_Unlimited" type="checkbox" class="flat"  onclick="enableDisable(this.checked, 'quantity')" data-parsley-multiple="Quantity_Unlimited" {{$product->quantity == null ? 'checked'  : ''}}> الكمية غير محدودة
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 pt-3">
                                ...
                                <input type="text" id="offer_price"  name="offer_price"  value="{{old('offer_price',$product->offer_price)}}" class="form-control" placeholder="offer_price">
                        ...
                        <div class="row">
                            <div class="col-md-6 com-sm-12 pt-4">
                                ...
                                <div class="form-group">
                                    <input type="text" id="offer_ends" name="offer_ends" value="{{old('offer_ends',$product->offer_ends)}}" class="form-control" >
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <input type="number" name="max_order" id="max_order" value="{{old('max_order',$product->max_order)}}" min="0" class="form-control" placeholder="0" data-parsley-range="[-1,1000]" data-parsley-required-message="هذا الحقل مطلوب." placeholder="0" data-parsley-range="[-1,1000]" data-parsley-range-message="قيمة هذا الحقل بين [0,999].">
                        ...
                        <div class="row">
                            <div class="col-6 pt-4">
                                ...
                                <select name="status" class="form-control">
                                    <option value="1" {{ old('status',$product->status) == '1' ? 'selected' : null}}>مفعل</option>
                                    <option value="0" {{ old('status',$product->status) == '0' ? 'selected' : null}}>غير مفعل</option>
                                </select>
                            ...
                            <div class="col-6 pt-4">
                                ...
                                <select name="featured" class="form-control">
                                    <option value="1" {{ old('featured',$product->featured) == '1' ? 'selected' : null}}>نعم</option>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <select name="tags[]" class="form-control select2" multiple="multiple">
                                    @forelse ($tags as $tag)
                                        <option value="{{$tag->id}}" {{in_array($tag->id , old('tags',$product->tags->pluck('id')->toArray())) ? 'selected' : null }}  >{{$tag->name}}</option>
                                    @empty
                                    @endforelse
                                </select>
                            </div>
                    ...
                    @if($product->photos()->count() > 0)
                        @foreach($product->photos as $media)
                            { 
                                ...
                                url: "{{route('admin.product_cards.remove_image' , ['image_id' => $media->id , 'product_id' => $product->id , '_token'=> csrf_token()]) }}", 
                                key:{{ $media->id}} 
                            },                        
                        @endforeach
                    @endif
