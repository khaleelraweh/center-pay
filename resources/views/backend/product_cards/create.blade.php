...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">إضافة بطاقة</h6>
            <div class="ml-auto">
                <a href="{{route('admin.product_cards.index')}}" class="btn btn-primary">
                    <span class="icon text-white-50">
                        <i class="fa fa-home"></i>
                    </span>
                    <span class="text">إدارة البطائق</span>
                </a>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{route('admin.product_cards.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="tab-pane fade" id="pricing" role="tabpanel" aria-labelledby="pricing-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <input type="number" name="quantity" id="quantity" value="{{old(0,'quantity')}}" min="0" class="form-control" placeholder="quantity" data-parsley-range="[-1,1000]" data-parsley-required-message="هذا الحقل مطلوب." placeholder="0" data-parsley-range="[-1,1000]" data-parsley-range-message="قيمة هذا الحقل بين [0,999].">
                                @error('quantity') <span class="text-danger">{{$message}}</span> @enderror                        
                                
                                <div class="col-md-12 col-sm-12 ">
                                    <label class="col-form-label col-md-12 col-sm-12 ">
                                      <input name="Quantity_Unlimited" type="checkbox" class="flat" onclick="enableDisable(this.checked, 'quantity')" data-parsley-multiple="Quantity_Unlimited"> الكمية غير محدودة
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 pt-3">
                                ...
                                <input type="text" name="offer_price" id="offer_price" value="{{old('offer_price')}}" class="form-control" placeholder="offer_price">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 pt-4">
                                ...
                                <input type="number" name="max_order" id="max_order" value="{{old(0,'max_order')}}" min="0" class="form-control" placeholder="0" data-parsley-range="[-1,1000]" data-parsley-required-message="هذا الحقل مطلوب." placeholder="0" data-parsley-range="[-1,1000]" data-parsley-range-message="قيمة هذا الحقل بين [0,999].">
