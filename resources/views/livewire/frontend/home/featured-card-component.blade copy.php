                    ...
                    <div class="prd-inside">
                        <div class="prd-img-area">
                            <a href="{{ route('frontend.card', $featured_card->slug) }}" class="prd-img image-container">
                                {{-- first image  --}}
                                <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{ asset('assets/cards/' . $featured_card->firstMedia->file_name) }}" alt="بطائق الدفع" class="js-prd-img lazyload fade-up" />
                                {{-- second image in the same product card the other side  --}}
                                <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{ asset('assets/cards/' . $featured_card->lastMedia->file_name) }}" alt="بطائق الدفع" class="js-prd-img lazyload fade-up" />
                            ...
                            <div class="prd-circle-labels">
                                <a href="#" wire:click.prevent="store( 'wishlist' , {{ $featured_card->id }} , '{{ $featured_card->name }}' , 1 , {{ $featured_card->price }})" class="circle-label-compare circle-label-wishlist--add js-add-wishlist mt-0" title="Add To Wishlist">
                            ...
                            <div class="prd-hovers">
                                ...
                                <div class="prd-action">
                                    <div class="prd-action-left">
                                        <form action="#">
                                            <button class="btn js-prd-addtocart rounded-pill" wire:click.prevent="store( 'default' , {{ $featured_card->id }} , '{{ $featured_card->name }}' , 1 , {{ $featured_card->price }})" data-product='{"name": "{{ $featured_card->name }}", "path":"{{ asset('assets/cards/' . $featured_card->firstMedia->file_name) }}", "url":"{{ route('frontend.card', $featured_card->slug) }}", "aspect_ratio":0.778}'>
