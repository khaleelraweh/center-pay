        ...
        <div class="mobilemenu-scroll">
          ...
          <div class="nav-wrapper show-menu">
            ...
            <ul class="nav nav-level-1">
              <li>
                <a href="index.html"
                  >تخطيط<span class="menu-label menu-label--color1"
                    >الصفحات</span
                ...
                <ul class="nav-level-2">
                  ...
                  <li>
                    <a href="#"
                      >Books Skin<span class="menu-label menu-label--color1"
                        >Coming Soon</span
                      ></a
                    >
                  </li>
                  <li>
                    <a href="#"
                      >Electronics Skin<span
                        class="menu-label menu-label--color2"
                        >Coming Soon</span
                      ></a
                    >
                  </li>
                  <li>
                    <a href="#"
                      >Games Skin<span class="menu-label menu-label--color3"
                        >Coming Soon</span
                      ></a
                    >
                  </li>
                  <li>
                    <a href="#"
                      >Vaping Skin<span class="menu-label"
                        >Coming Soon</span
                      ></a
                    >
                  </li>
              ...
              <li>
                <a href="#"
                  >الاقسام<span class="arrow"
                    ><i class="icon-angle-right"></i></span
                ></a>
                <ul class="nav-level-2">
                  <li>
                    <a href="product.html"
                      >Product page<span class="arrow"
                        ><i class="icon-angle-right"></i></span
                    ></a>
                    <ul class="nav-level-3">
                      <li>
                        <a href="product.html"
                          >Product page variant 1<span
                            class="menu-label menu-label--color3"
                            >Popular</span
                          ></a
                        >
                      </li>
                  ...
                  <li>
                    <a href="category.html"
                      >Category page<span class="arrow"
                        ><i class="icon-angle-right"></i></span
                    ></a>
                    <ul class="nav-level-3">
                      <li>
                      ...
                      <li>
                        <a href="category-closed-filter.html"
                          >Closed filters</a
                        >
                      </li>
                      <li>
                        <a href="category-horizontal-filter.html"
                  ...
                  <li>
                    <a href="cart.html"
                      >Cart & Checkout<span class="arrow"
                        ><i class="icon-angle-right"></i></span
                    ></a>
                    <ul class="nav-level-3">
          ...
          <div class="mobilemenu-bottom">
              ...
              <div class="dropdn_currency">
                <div class="dropdn dropdn_caret">
                  <a href="#" class="dropdn-link js-dropdn-link"
                    >دولار امريكي<i class="icon-angle-down"></i
                  ></a>
            ...
            <div class="mobilemenu-language">
              <div class="dropdn_language">
                <div
                  class="dropdn dropdn_language dropdn_language--noimg dropdn_caret"
                >
                  <a href="#" class="dropdn-link js-dropdn-link"
                    ><span class="js-dropdn-select-current">العربية</span
    ...
    <div class="dropdn-content account-drop" id="dropdnAccount">
      <div class="dropdn-content-block">
        ...
        <ul>
          <li>
            <a href="account-create.html"
              ><span>تسجيل الدخول</span><i class="icon-login"></i
            ></a>
          </li>
          <li>
            <a href="account-create.html"
              ><span>انشاء حساب</span><i class="icon-user2"></i
            ></a>
          </li>
          <li>
            <a href="checkout.html"
              ><span>الدفع</span><i class="icon-card"></i
            ></a>
          </li>
        </ul>
        <div class="dropdn-form-wrapper">
          ...
          <form action="#">
            ...
            <button type="submit" class="btn">تسجل الدخول</button>
          </form>
        </div>
      </div>
      ...
      <div class="dropdn-content-block">
        ...
        <div class="minicart-drop-content js-dropdn-content-scroll">
          ...
          <div class="minicart-drop-info d-none d-md-block">
            <div
              class="shop-feature-single row no-gutters align-items-center"
            >
        ...
        <div class="minicart-drop-fixed js-hide-empty">
          ...
          <div
            class="minicart-drop-total js-minicart-drop-total row no-gutters align-items-center"
          >
          ...
          <div class="minicart-drop-actions">
            <a href="cart.html" class="btn btn--md btn--grey"
              ><i class="icon-basket"></i><span>سلة المشتريات</span></a
            >
            <a href="checkout.html" class="btn btn--md"
              ><i class="icon-checkout"></i><span>عملية الدفع</span></a
            >
          </div>
