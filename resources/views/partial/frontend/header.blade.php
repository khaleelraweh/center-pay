            ...
            <div class="hdr-inline-link">
              <div class="search_container_desktop">
                <div class="dropdn dropdn_search dropdn_fullwidth">
                  <a href="#" class="dropdn-link js-dropdn-link only-icon"
                    ...
                    ><span class="dropdn-link-txt">بحث عن</span></a
                  >
              ...
              <div class="dropdn dropdn_account dropdn_fullheight">
                <a
                  ...
                  ><i class="icon-user"></i
                  ><span class="dropdn-link-txt">حسابي</span></a
                >
              </div>
              <div class="dropdn dropdn_fullheight minicart">
                <a
                  href="#"
                  class="dropdn-link js-dropdn-link minicart-link only-icon"
              ...
              <ul class="mmenu mmenu-js">
                    ...
                    <ul class="submenu-list">
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="product-2.html"
                              >Product page variant 2</a
                            >
                          </li>
                          <li>
                            <a href="product-3.html"
                              >Product page variant 3</a
                            >
                          </li>
                          <li>
                            <a href="product-4.html"
                              >Product page variant 4</a
                            >
                          </li>
                          <li>
                            <a href="product-5.html"
                              >Product page variant 5</a
                            >
                          </li>
                          <li>
                            <a href="product-6.html"
                              >Product page variant 6</a
                            >
                          </li>
                          <li>
                            <a href="product-7.html"
                              >Product page variant 7</a
                            >
                          </li>
                        </ul>
                      </li>
                      ...
                      <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="blog-sticky-sidebar.html"
                              >Sticky sidebar</a
                            >
                          </li>
                ...
                <li class="mmenu-item--mega">
                  <a href="collections.html"
                    ><span>الكروت<span class="menu-label">الشحن</span></span></a
                  >
                      ...
                      <div class="container">
                        ...
                        <div class="mmenu-cols column-4">
                            ...
                            <ul class="submenu-list">
                              <li>
                                <a href="category.html"
                                  >Martins d'Art 2020/21<span
                                    class="submenu-link-txt"
                                    >Available in boutiques from June
                                    2019</span
                                  ></a
                                >
                              </li>
                              ...
                              <li>
                                <a href="category.html"
                                  >Spring-Summer 2021 Pre-Collection<span
                                    class="submenu-link-txt"
                                    >In boutiques</span
                                  ></a
                                >
                            ...
                            <ul class="submenu-list">
                              <li>
                                ...
                                <ul class="sub-level">
                                  ...
                                  <li>
                                    <a href="category.html"
                                      >Blouson Jacket<span class="menu-label"
                                        >SALE</span
                                      ></a
                                    >
                                  </li>
                          ...
                          <div class="mmenu-col">
                            ...
                            <ul class="submenu-list">
                              ...
                              <li>
                                <a href="category.html"
                                  >Skirts<span
                                    class="menu-label menu-label--color1"
                                    >SALE</span
                                  ></a
                                >
                              </li>
                          ...
                          <div class="mmenu-bottom justify-content-center">
                            <a href="#"
                              ><i class="icon-fox icon--lg"></i
                              ><b>مركز اخبار سنتر باي</b
                  ...
                  <div class="dropdn_language">
                    ...
                    >
                      <a href="#" class="dropdn-link js-dropdn-link"
                        ><span class="js-dropdn-select-current mainBtnLang">اللغة</span
