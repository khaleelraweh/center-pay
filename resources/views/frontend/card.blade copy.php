    ...
    <div class="holder breadcrumbs-wrap mt-0">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li><a href="{{ route('frontend.card_category', $card->category->slug) }}">{{ $card->category->category_name }}</a>
                </li>
        ...
        <div class="container js-prd-gallery" id="prdGallery">
            ...
            <div class="row prd-block prd-block--prv-bottom">
                            ...
                            <div class="prd-block_main-image-holder" id="prdMainImage">
                                ...
                                <div class="product-main-carousel js-product-main-carousel" data-zoom-position="inner">
                                    ...
                                    <div data-value="Beige">
                                        <span class="prd-img">
                                            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{ asset('assets/cards/' . $photo->file_name) }}" alt="{{ $card->name }}" data-zoom-image="{{ asset('assets/cards/' . $photo->file_name) }}" />
                                        </span>
                                    </div>
                                    @endforeach
                        ...
                        <div class="product-previews-wrapper">
                            ...
                            <div class="product-previews-carousel js-product-previews-carousel">
                                ...
                                <a href="#" data-value="Beige">
                                    <span class="prd-img">
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{ asset('assets/cards/' . $photo->file_name) }}" class="lazyload fade-up" alt="" />
                                    </span>
                                </a>
                                @endforeach
                ...
                <div class="col-md-7 col-lg-7 col-xl-7 mt-1 mt-md-0">
                    ...
                    <div class="prd-block_info prd-block_info--style1" data-prd-handle="/cards/copy-of-suede-leather-mini-skirt">
                        ...
                        <div class="prd-block_info-top prd-block_info_item order-0 order-md-2">
                            <div class="prd-block_price prd-block_price--style2">
                                <div class="prd-block_price--actual main-color" style="font-size: 20px; font-weight:bold">
                                ...
                                <div class="prd-block_price-old-wrap" style="margin-top:0; margin-top:10px;padding:0">
                                    ...
                                    <span class="prd-block_price--text prd-block_price--old" style="padding: 0px;font-size:20px;">
                                        <small>
                        ...
                        <div class="prd-block_description prd-block_info_item ">
                            ...
                            <div class="section">
                                ...
                                <div class="mt-1"></div>
                                <a class="button jkit-btn-inverse toggle  btn-link" style="cursor: pointer;">Read
                                    More</a>
                            </div>
                        </div>
                    ...
                    <div id="contactModal" style="display: none;" class="modal-info-content modal-info-content-sm">
                        ...
                        <form method="post" action="#" id="contactForm" class="contact-form">
                            <div class="form-group">
                                <input type="text" name="contact[name]" class="form-control form-control--sm" placeholder="الاسم">
                            </div>
                            <div class="form-group">
                                <input type="text" name="contact[email]" class="form-control form-control--sm" placeholder="الايميل" required="">
                            </div>
                            <div class="form-group">
                                <input type="text" name="contact[phone]" class="form-control form-control--sm" placeholder="رقم التلفون">
                            </div>
                            <div class="form-group">
