...
class RandomCardComponent extends Component
{
    ...
    public function addToCart($id)
    {
        ...
        if ($duplicates->isNotEmpty()) {
            ...
            Cart::instance('default')->add($card->id, $card->product_name, 1, $card->price)->associate(Card::class);
    ...
    public function addToWishList($id)
    {
        ...
        if ($duplicates->isNotEmpty()) {
            ...
            Cart::instance('wishlist')->add($card->id, $card->product_name, 1, $card->price)->associate(Card::class);
            $this->emit('updateCart');
